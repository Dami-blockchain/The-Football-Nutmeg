...
class Settings(BaseSettings):
    ...
    # when settlement got to them.
    #
    # Default "auto" derives 1 August of the current football year, which
    # precedes every top-5 opening weekend and follows a summer tournament
    # final. A hardcoded date would silently expire next August. Set an ISO
    # date to pin a boundary, or empty to disable season scoping.
    season_start: str = Field(default="auto", alias="BETBOT_SEASON_START")
